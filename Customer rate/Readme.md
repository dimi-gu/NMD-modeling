...
Place the following input files in the same directory of the notebook:
...
Forecast errors and RMSE are calculated, and actual versus predicted rates are plotted. In particular, for 
